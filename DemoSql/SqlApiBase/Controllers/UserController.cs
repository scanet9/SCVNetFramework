...
namespace SqlApiBase.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [AllowAnonymous]
        [HttpPost]
        public async Task<IActionResult> RegisterAsync([FromBody] RegisterUserRequestDto registerUserDto)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateUserAsync(Guid id, [FromBody] UpdateUserRequestDto updateUserDto)
        {
            try
            {
